...
public class ZAxisMesh extends Mesh {
	
	/**
	 * Default constructor for an arrow mesh oriented to the Z-Axis.
	 */
	public ZAxisMesh() {
	...
	/**
	 * Constructor for an arrow mesh oriented to the Z-Axis.
	 * 
	 * @param t
	 *            Arrow thickness
	 * @param l
	 ...
	 *            Arrow head length
	 */
	public ZAxisMesh(final float t, final float l, final float ht, final float hl) {
		super(
				//@formatter:off
				new Vertex[] {
