...
public class TestGame extends Game {
	...
	public void initialize() {
		...
		// Materials
		Material materialReferenceXAxis = new Material(new Vector3f(0.5f, 0.0f, 0.0f), 1, 8);
		Material materialReferenceYAxis = new Material(new Vector3f(0.0f, 0.5f, 0.0f), 1, 8);
		Material materialReferenceZAxis = new Material(new Vector3f(0.0f, 0.0f, 0.5f), 1, 8);
