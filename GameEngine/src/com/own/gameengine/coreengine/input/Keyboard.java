...
public class Keyboard extends GLFWKeyCallback {
	...
	private static final int	GLFW_KEY_DOWN	= 1;
	...
	public boolean getKey(final int keyCode) {
		return GLFW.glfwGetKey(windowID, keyCode) == GLFW_KEY_DOWN;
	}
	
	public boolean getKeyDown(final int keyCode) {
		return getKey(keyCode) && !lastKeys[keyCode];
	}
	
	public boolean getKeyUp(final int keyCode) {
		return !getKey(keyCode) && lastKeys[keyCode];
	}
